...
public class ScheduleController {
    ...
    public ResponseEntity<ScheduleResponse> update(
            Authentication authentication,
            @PathVariable("scheduleId") Long scheduleId,
            @RequestBody UpdateScheduleRequest requestBody,
            HttpServletRequest request,
            HttpServletResponse response
    ) {
        return ResponseEntity.ok()
                .cacheControl(CacheControl.noStore())
                .body(scheduleService.update(authentication, scheduleId, requestBody, request, response));
    }
    ...
    public ResponseEntity<Void> delete(
        ...
        scheduleService.delete(authentication, scheduleId, version, request, response);
